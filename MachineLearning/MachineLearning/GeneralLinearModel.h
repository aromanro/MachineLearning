...
template<typename InputType, typename OutputType, typename WeightsType, class Solver, class BatchInputType = Eigen::MatrixXd, class BatchOutputType = BatchInputType> class GeneralLinearModel 
	: public GeneralizedLinearModel<InputType, OutputType, WeightsType, Solver, BatchInputType, BatchOutputType, IdentityFunction<OutputType>>
{
public:
	typedef GeneralizedLinearModel<InputType, OutputType, WeightsType, Solver, BatchInputType, BatchOutputType, IdentityFunction<OutputType>> baseType;
