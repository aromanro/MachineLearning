...
bool NeuralNetworkTestsMNIST()
{
	...
	NeuralNetworks::MultilayerPerceptron<SGD::SoftmaxRegressionAdamSolver/*, HiddenLayerAlternative*/> neuralNetwork(/*{nrInputs, 1000, 100, nrOutputs}*/{ nrInputs, 1000, 800, 400, 100, nrOutputs }, { 0.2, 0.15, 0.1, 0, 0 }); // don't use dropout right before the softmax layer
